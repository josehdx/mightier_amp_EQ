...
class EQSixBand extends EQ {
  ...
  List<Parameter> parameters = [
    Parameter(
        ...
        midiControllerHandle: MidiControllerHandles.eqBand1),
    Parameter(
        name: "220",
        handle: "eq_p2",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand2),
    Parameter(
        name: "500",
        handle: "eq_p3",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand3),
    ...
    Parameter(
        ...
        midiControllerHandle: MidiControllerHandles.eqBand4),
    Parameter(
        name: "2.6K",
        handle: "eq_p5",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand5),
    Parameter(
        name: "6.4K",
        handle: "eq_p6",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand6),
  ];
}
...
class EQTenBand extends EQ {
  ...
  List<Parameter> parameters = [
    Parameter(
        ...
        devicePresetIndex: PresetDataIndexPlugPro.EQ_Para1,
        midiCC: MidiCCValuesPro.EQ_Para1,
        midiControllerHandle: MidiControllerHandles.eqVolume),
    Parameter(
        name: "31",
        handle: "eq_b1",
        value: 0,
    ...
    Parameter(
        ...
        midiControllerHandle: MidiControllerHandles.eqBand7),
    Parameter(
        name: "4K",
        handle: "eq_b8",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand8),
    Parameter(
        name: "8K",
        handle: "eq_b9",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand9),
    Parameter(
        name: "16K",
        handle: "eq_b10",
        value: 0,
        ...
        midiControllerHandle: MidiControllerHandles.eqBand10),
  ];
}
